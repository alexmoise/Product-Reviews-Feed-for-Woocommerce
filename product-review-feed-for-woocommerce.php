...
// FIXME This needs to be in register_activation_hook() and in register_deactivation_hook()
// global $wp_rewrite;
// $wp_rewrite->flush_rules();

add_action( 'init', 'mos_add_the_product_feed' );
add_action( 'parse_query', 'mos_add_hooks' );
...
function mos_order_item_save_gtin( $item, $cart_item_key, $cart_item, $order ) {
	$value = $cart_item['data']->get_meta( '_gtin' );
	if ( $value ) {
